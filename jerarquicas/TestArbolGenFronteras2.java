 ...
 */
public class TestArbolGenFronteras2 {
    ...
    public static void main(String[] arg) {
        ...
        //Declaracion de ArbolGen de intergers
        ArbolGen arbolVacio = new ArbolGen();
        ArbolGen arbol= new ArbolGen();
        inicializadorArbolGen(arbol);
        ...
        //Creacion de Listas de intergers
        ...
        inicializadorListaConFrontera(lsConFrontera);
        inicializadorListaConYSinFrontera(lsConYSinFrontera);
        inicializadorListaSinFrontera(lsSinFrontera);
        inicializadorListaSinElemDelArbol(lsSinElementosDelArbol);
    ...
    public static ArbolGen inicializadorArbolGen(ArbolGen arbol){
        arbol.insertar(1, 1);
        arbol.insertar(2, 1);
        arbol.insertar(3, 1);
        arbol.insertar(4, 1);
    ...
    public static Lista inicializadorListaConFrontera(Lista lsConFrontera){
        
        Object[] arreglo = new Object[]{3,14,7,16,12};
        lsConFrontera.arregloALista(arreglo);
        return lsConFrontera;
    }
    public static Lista inicializadorListaConYSinFrontera(Lista lsConYSinFrontera){
        
        Object[] arreglo = new Object[]{14,4,15,10,18};
        lsConYSinFrontera.arregloALista(arreglo);
        return lsConYSinFrontera;
    }
    public static Lista inicializadorListaSinFrontera(Lista lsSinFrontera){
        
        Object[] arreglo = new Object[]{1,4,13,9,2};
        lsSinFrontera.arregloALista(arreglo);
        return lsSinFrontera;
    }
    public static Lista inicializadorListaSinElemDelArbol(Lista lsSinElementosDelArbol){
        
        Object[] arreglo = new Object[]{21,'a',42,"hola",1.5};
        lsSinElementosDelArbol.arregloALista(arreglo);
        return lsSinElementosDelArbol;
    }
